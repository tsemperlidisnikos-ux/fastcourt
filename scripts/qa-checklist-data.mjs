...
export const QA_META = {
  ...
  stagingUrl: "https://fastcourt-next.vercel.app",
...
export const QA_MODULES = [
    ...
    sections: [
      {
        ...
        title: "Login & Signup",
        items: [
          { id: "AUTH-01", priority: "P0", item: "Email/password login succeeds", steps: "Go to /login (or / → redirect), enter valid credentials", expected: "Redirect to /library, session active" },
          { id: "AUTH-01b", priority: "P0", item: "Root URL has no marketing landing", steps: "Open / logged out and logged in", expected: "Redirects to /library (then /login if needed); no pricing landing page" },
          ...
          { id: "AUTH-09", priority: "P1", item: "Default FastCourt logo on login", steps: "Clear custom app logo if set; hard refresh", expected: "Orange mark + FASTCOURT wordmark (not old blue F)" },
        ],
      },
      {
        id: "onboarding",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "DRW-15b", priority: "P0", item: "Preview frames grid columns (admin setting)", steps: "Admin Appearance → Columns=2 → Apply → open Library preview with 4+ frames", expected: "2 frames side-by-side (not locked to 3)" },
          { id: "DRW-15c", priority: "P0", item: "Frames grid syncs to coach account", steps: "Admin sets Columns=2 → Apply → login as coach", expected: "Coach also sees 2 columns (not default 3)" },
          { id: "DRW-16", priority: "P2", item: "List/preview split width from settings", expected: "Layout matches Appearance list split %" },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "PB-11", priority: "P1", item: "Print settings — live preview without Save", expected: "Changing options updates preview immediately" },
          { id: "PB-11b", priority: "P1", item: "Print TOC grouped by series/tags", expected: "Table of contents groups correctly" },
          { id: "PB-11c", priority: "P1", item: "showPlayTitles toggle", expected: "Titles appear/hide; do not consume frame slots" },
          { id: "PB-11d", priority: "P2", item: "eachPlayNewLine packing", expected: "Plays pack / pad as configured" },
  ...
  },
  {
    ...
    sections: [
      {
        id: "os-core",
        title: "Reports & Players",
        items: [
          { id: "OS-01", priority: "P0", item: "Create new scout report", steps: "Opponent Scout → New → team name → Save", expected: "Report in sidebar list" },
          { id: "OS-02", priority: "P0", item: "Add players + stats + strengths/weaknesses", expected: "Fields save; Ctrl+S works" },
          { id: "OS-03", priority: "P1", item: "Upload team logo + player photo", expected: "Images compress; appear in editor" },
          { id: "OS-04", priority: "P1", item: "Duplicate report", expected: "Copy with “(copy)” name, new ids" },
          { id: "OS-05", priority: "P1", item: "Delete report with confirm", expected: "Removed from list" },
          { id: "OS-06", priority: "P1", item: "Unsaved guard", steps: "Edit → switch report / New / close tab", expected: "Confirm discard or beforeunload" },
          { id: "OS-07", priority: "P2", item: "Quota error on huge photos", expected: "Friendly storage message, no crash" },
        ],
      },
      {
        id: "os-print",
        title: "Print",
        items: [
          { id: "OS-10", priority: "P0", item: "Print / Export scout PDF", expected: "Players, logo, strengths/weaknesses" },
          { id: "OS-11", priority: "P1", item: "Empty stats hidden (no — clutter)", expected: "Only filled stat columns print" },
          { id: "OS-12", priority: "P2", item: "Page footer only if multi-page", expected: "No fake “1 of 1” alone" },
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "GP-22b", priority: "P0", item: "Timeout counters panel — list / edit / delete", steps: "Game Plan → Timeout counters", expected: "Cues listed; edit fields; remove; priority changes Game Day order" },
          { id: "GP-22c", priority: "P0", item: "Add counter from Counter Library", steps: "From library → pick tagged defense play", expected: "Cue created with defensePlayId; optional add to Defense category" },
          { id: "GP-22d", priority: "P1", item: "Add counter manually", steps: "Add manual → fill title/detail/coverage", expected: "Cue on plan; appears in Timeout / Game Day top 3 by priority" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "GP-37", priority: "P1", item: "Opponent read rollup on game plan", steps: "Prep vs opponent + mark reads", expected: "vs Opponent panel shows call-level % landed" },
          { id: "GP-38", priority: "P1", item: "Game Day / timeout read success %", steps: "Marked reads in prep vs opponent", expected: "Offense read cards + timeout slides show e.g. 67% landed" },
          { id: "GP-39", priority: "P1", item: "Prep read drill recommendations", steps: "Weak reads vs opponent + timeout coverage cues", expected: "Prep read drills panel lists calls, blocks, coverage badge" },
          { id: "GP-40", priority: "P1", item: "One-click prep with read drills", steps: "Prep practice on game plan with recommendations", expected: "Session includes plan plays + auto-added read drill blocks" },
          { id: "GP-41", priority: "P1", item: "Post-game read import on archive", steps: "Mark reads in prep then archive game plan", expected: "Post-game notes pre-filled with vs opponent read summary" },
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "PRC-18", priority: "P1", item: "Player attribution on read outcome", steps: "Roster players + Practice Live CALL block", expected: "Select player when marking Landed/Missed; persists readPlayerId" },
        ],
      },
      {
        id: "prac-export",
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "COH-05", priority: "P1", item: "Season trend (10 sessions)", steps: "Mark reads across 3+ practice sessions", expected: "Season chart shows up to 10 dated bars oldest→newest" },
          { id: "COH-06", priority: "P1", item: "Player read attribution panel", steps: "Assign players in Practice Live", expected: "Dashboard lists per-player % landed + top calls" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "DSG-06", priority: "P0", item: "Undo/redo (Ctrl+Z / Ctrl+Y)", expected: "5+ steps reversible" },
          { id: "DSG-07", priority: "P1", item: "Save stays in editor (Ctrl+S)", expected: "Saved notice; remain on /designer" },
          { id: "DSG-08", priority: "P1", item: "Line mode P = Pass", expected: "Pass action drawn" },
          { id: "DSG-09", priority: "P1", item: "Frame nav [ ] and Ctrl+D duplicate", expected: "Prev/next frame; duplicate frame" },
        ],
      },
      {
        id: "des-frames",
    ...
    sections: [
      {
        ...
        items: [
          { id: "FIL-01", priority: "P0", item: "Upload MP4 session (button)", expected: "Session in sidebar, video plays" },
          { id: "FIL-01b", priority: "P1", item: "Drag-drop MP4 upload", expected: "Same as button upload; quota errors friendly" },
          { id: "FIL-02", priority: "P2", item: "YouTube URL session (if still enabled)", expected: "Embeds and scrubs — or feature removed" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "FIL-12", priority: "P0", item: "Space always play/pause", expected: "Works even when focus not on video" },
          { id: "FIL-12b", priority: "P1", item: "Jog ←/→ or J/L", expected: "Frame/time jog" },
          { id: "FIL-12c", priority: "P1", item: "Fullscreen F", expected: "Works in fullscreen" },
          { id: "FIL-13", priority: "P2", item: "Clear drawing vs AC", expected: "Clear removes strokes; AC behaves as designed" },
        ],
      },
      {
        id: "film-tags",
        title: "Coach Tags & Bookmarks",
        items: [
          ...
          { id: "FIL-22", priority: "P0", item: "Add chapter bookmark (B key)", expected: "Bookmark created; no Chapter UI panel required" },
          { id: "FIL-23", priority: "P2", item: "Chapter panel removed from UI", expected: "No “Chapter at… / Add chapter” card in sidebar" },
          { id: "FIL-24", priority: "P1", item: "Possession playlist seeks bookmarks", expected: "Jump to timestamp from list" },
          { id: "FIL-25", priority: "P0", item: "Disruption tags H/W/I/T/D/K/P/C/O", expected: "Red markers, disruption panel" },
          { id: "FIL-26", priority: "P1", item: "Plan broke here via Shift+B (if scout tools on)", expected: "Disruption bookmark; no Plan broke button in chapter bar" },
        ],
      },
      {
        id: "film-disruption",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "SET-13", priority: "P0", item: "Apply trial on user (All users)", steps: "Set trial days → Apply trial → Apply", expected: "No RLS Cloud sync error; expiresAt updates" },
          { id: "SET-14", priority: "P0", item: "Appearance frames Columns Apply for all coaches", steps: "Columns=2 → Apply → login as coach", expected: "Coach preview uses 2 columns" },
          { id: "SET-15", priority: "P1", item: "App logo upload / clear to default", expected: "Custom logo shows; Clear restores default orange logo" },
          { id: "SET-16", priority: "P1", item: "Billing prices display", expected: "€99 / €10 / club seats match config" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "CLD-04", priority: "P0", item: "Team library shared for org coaches", steps: "2 coaches same org", expected: "Same plays visible" },
          { id: "CLD-05", priority: "P1", item: "Empty library protect (no wipe)", expected: "Cloud not overwritten by empty local" },
        ],
      },
      {
        id: "pwa",
        ...
        items: [
          ...
          { id: "PWA-04", priority: "P1", item: "iPad logo after cache clear", steps: "Safari clear website data → reopen", expected: "New default logo (not stale cache)" },
        ],
      },
    ],
  },
  {
    id: "smoke",
    title: "Production Smoke (fastcourt.eu / vercel.app)",
    sections: [
      {
        id: "prod",
        ...
        items: [
          ...
          { id: "SMK-06", priority: "P0", item: "Opponent Scout save + print", expected: "Report persists and prints" },
          { id: "SMK-07", priority: "P1", item: "Admin Apply trial without Cloud sync error", expected: "No RLS profiles error" },
        ],
      },
    ],
  },
