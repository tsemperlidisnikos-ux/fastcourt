...
export const FEATURE_DOMAINS = [
  ...
  },
  {
    ...
    tests: [
      ...
      "film-scout-print.test.ts",
      "film-room-bookmarks.test.ts",
      "film-game-plan-evidence.test.ts",
    ...
    modules: [
      ...
      "src/components/film-room/FilmScoutPrintDocument.tsx",
      "src/lib/film-room/film-scout-print-model.ts",
      "src/lib/film-room/film-room-bookmarks.ts",
      "src/lib/film-room/film-game-plan-evidence.ts",
      "src/components/film-room/FilmRoomBookmarkBar.tsx",
      "src/components/library/GamePlanFilmEvidencePanel.tsx",
